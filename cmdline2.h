...
#define CMDLINE_PARSER_PACKAGE "latent_oc_svm_tool"
#endif

#ifndef CMDLINE_PARSER_VERSION
#define CMDLINE_PARSER_VERSION "2012.8"
#endif
...
struct gengetopt_args_info
{
  ...
  int topic_arg;	/* set topic number of latent one-class SVM (default='2').  */
  char * topic_orig;	/* set topic number of latent one-class SVM original value given at command line.  */
  const char *topic_help; /* set topic number of latent one-class SVM help description.  */
  float cost_arg;	/* set Cost of p(w) in one class SVM (default='1').  */
  char * cost_orig;	/* set Cost of p(w) in one class SVM original value given at command line.  */
  const char *cost_help; /* set Cost of p(w) in one class SVM help description.  */
  float zcost_arg;	/* set Cost of p(z) in one class SVM (default='1').  */
  char * zcost_orig;	/* set Cost of p(z) in one class SVM original value given at command line.  */
  const char *zcost_help; /* set Cost of p(z) in one class SVM help description.  */
  ...
  int witer_arg;	/* inner iterations for p(w) (sgd) (default='20').  */
  char * witer_orig;	/* inner iterations for p(w) (sgd) original value given at command line.  */
  const char *witer_help; /* inner iterations for p(w) (sgd) help description.  */
  int ziter_arg;	/* inner iterations for p(z) (sgd) (default='20').  */
  char * ziter_orig;	/* inner iterations for p(z) (sgd) original value given at command line.  */
  const char *ziter_help; /* inner iterations for p(z) (sgd) help description.  */
  float tol_arg;	/* set Tolerance (default='1e-05').  */
  ...
  int buf_arg;	/* number of new constraints to accumulated before recomputing the QP (sgd) (default='1000').  */
  ...
  int topic_given ;	/* Whether topic was given.  */
  int cost_given ;	/* Whether cost was given.  */
  int zcost_given ;	/* Whether zcost was given.  */
  ...
  int witer_given ;	/* Whether witer was given.  */
  int ziter_given ;	/* Whether ziter was given.  */
