/*
  ...
  C:\MinGW\msys\1.0\local\bin\gengetopt.exe -i latent_oc_svm.ggo -u -F cmdline2 
...
const char *gengetopt_args_info_purpose = "A command line utility to train/test latent one-class SVM.";

const char *gengetopt_args_info_usage = "Usage: latent_oc_svm_tool [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nTraining options:",
  "  -t, --topic=INT        set topic number of latent one-class SVM  \n                           (default=`2')",
  "  -c, --cost=FLOAT       set Cost of p(w) in one class SVM  (default=`1')",
  "      --zcost=FLOAT      set Cost of p(z) in one class SVM  (default=`1')",
  ...
  "      --witer=INT        inner iterations for p(w) (sgd)  (default=`20')",
  "      --ziter=INT        inner iterations for p(z) (sgd)  (default=`20')",
  "      --tol=FLOAT        set Tolerance  (default=`1e-05')",
  "      --period=INT       save model periodically (sgd)  (default=`0')",
  "  -v, --verbose          verbose mode  (default=off)",
  "\nPredict options:",
  "  -o, --output=STRING    prediction output filename",
  "\nlatent one-class SVM options:",
  "  -e, --epsilon=FLOAT    set epsilon  (default=`0.001')",
  "      --buf=INT          number of new constraints to accumulated before \n                           recomputing the QP (sgd)  (default=`1000')",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->witer_given = 0 ;
  args_info->ziter_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->witer_arg = 20;
  args_info->witer_orig = NULL;
  args_info->ziter_arg = 20;
  args_info->ziter_orig = NULL;
  args_info->tol_arg = 1e-05;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->topic_help = gengetopt_args_info_help[3] ;
  args_info->cost_help = gengetopt_args_info_help[4] ;
  args_info->zcost_help = gengetopt_args_info_help[5] ;
  args_info->model_help = gengetopt_args_info_help[6] ;
  args_info->binary_help = gengetopt_args_info_help[7] ;
  args_info->skip_eval_help = gengetopt_args_info_help[8] ;
  args_info->random_help = gengetopt_args_info_help[9] ;
  args_info->train_num_help = gengetopt_args_info_help[10] ;
  args_info->iter_help = gengetopt_args_info_help[11] ;
  args_info->witer_help = gengetopt_args_info_help[12] ;
  args_info->ziter_help = gengetopt_args_info_help[13] ;
  args_info->tol_help = gengetopt_args_info_help[14] ;
  args_info->period_help = gengetopt_args_info_help[15] ;
  args_info->verbose_help = gengetopt_args_info_help[16] ;
  args_info->output_help = gengetopt_args_info_help[18] ;
  args_info->epsilon_help = gengetopt_args_info_help[20] ;
  args_info->buf_help = gengetopt_args_info_help[21] ;
  args_info->rm_inactive_help = gengetopt_args_info_help[22] ;
  args_info->kernel_help = gengetopt_args_info_help[24] ;
  args_info->gamma_help = gengetopt_args_info_help[25] ;
  args_info->coef_help = gengetopt_args_info_help[26] ;
  args_info->degree_help = gengetopt_args_info_help[27] ;
  args_info->predict_help = gengetopt_args_info_help[28] ;
  args_info->show_help = gengetopt_args_info_help[29] ;
  args_info->convert_help = gengetopt_args_info_help[30] ;
  args_info->one_slack_help = gengetopt_args_info_help[31] ;
  args_info->one_slack2_help = gengetopt_args_info_help[32] ;
  args_info->sgd_help = gengetopt_args_info_help[33] ;
  args_info->sgd2_help = gengetopt_args_info_help[34] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  unsigned int i;
  if (args_info->topic_orig)
    {
      free (args_info->topic_orig); /* free previous argument */
      args_info->topic_orig = 0;
    }
  ...
  if (args_info->zcost_orig)
    {
      free (args_info->zcost_orig); /* free previous argument */
      args_info->zcost_orig = 0;
    }
  ...
  if (args_info->witer_orig)
    {
      free (args_info->witer_orig); /* free previous argument */
      args_info->witer_orig = 0;
    }
  if (args_info->ziter_orig)
    {
      free (args_info->ziter_orig); /* free previous argument */
      args_info->ziter_orig = 0;
    }
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->zcost_given) {
    if (args_info->zcost_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "zcost", args_info->zcost_orig);
    } else {
      fprintf(outfile, "%s\n", "zcost");
    }
  }
  ...
  if (args_info->witer_given) {
    if (args_info->witer_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "witer", args_info->witer_orig);
    } else {
      fprintf(outfile, "%s\n", "witer");
    }
  }
  if (args_info->ziter_given) {
    if (args_info->ziter_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "ziter", args_info->ziter_orig);
    } else {
      fprintf(outfile, "%s\n", "ziter");
    }
  }
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVt:c:m:br:i:vo:e:p", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* set topic number of latent one-class SVM.  */
          if (local_args_info.topic_given)
            {
              fprintf (stderr, "%s: `--topic' (`-t') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->topic_given && ! override)
            continue;
          local_args_info.topic_given = 1;
          args_info->topic_given = 1;
          args_info->topic_arg = strtol (optarg, &stop_char, 0);
          if (!(stop_char && *stop_char == '\0')) {
            fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
            goto failure;
          }
          if (args_info->topic_orig)
            free (args_info->topic_orig); /* free previous string */
          args_info->topic_orig = gengetopt_strdup (optarg);
          break;

        case 'c':	/* set Cost of p(w) in one class SVM.  */
        ...
        case 0:	/* Long option with no short option */
          /* set Cost of p(z) in one class SVM.  */
          if (strcmp (long_options[option_index].name, "zcost") == 0)
          {
            if (local_args_info.zcost_given)
              {
                fprintf (stderr, "%s: `--zcost' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->zcost_given && ! override)
              continue;
            local_args_info.zcost_given = 1;
            args_info->zcost_given = 1;
            args_info->zcost_arg = (float)strtod (optarg, &stop_char);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->zcost_orig)
              free (args_info->zcost_orig); /* free previous string */
            args_info->zcost_orig = gengetopt_strdup (optarg);
          }
          ...
          /* inner iterations for p(w) (sgd).  */
          else if (strcmp (long_options[option_index].name, "witer") == 0)
          {
            if (local_args_info.witer_given)
              {
                fprintf (stderr, "%s: `--witer' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->witer_given && ! override)
              continue;
            local_args_info.witer_given = 1;
            args_info->witer_given = 1;
            args_info->witer_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->witer_orig)
              free (args_info->witer_orig); /* free previous string */
            args_info->witer_orig = gengetopt_strdup (optarg);
          }
          /* inner iterations for p(z) (sgd).  */
          else if (strcmp (long_options[option_index].name, "ziter") == 0)
          {
            if (local_args_info.ziter_given)
              {
                fprintf (stderr, "%s: `--ziter' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->ziter_given && ! override)
              continue;
            local_args_info.ziter_given = 1;
            args_info->ziter_given = 1;
            args_info->ziter_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->ziter_orig)
              free (args_info->ziter_orig); /* free previous string */
            args_info->ziter_orig = gengetopt_strdup (optarg);
          }
          /* set Tolerance.  */
          else if (strcmp (long_options[option_index].name, "tol") == 0)
          {
            if (local_args_info.tol_given)
              {
                fprintf (stderr, "%s: `--tol' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
